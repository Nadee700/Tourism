...
public class InsertVehicle {
     private String VehicleID,TransportMode,VehicleType,Description,Image;
    private int ChassisNo,NoOfSeats,HiredPrice,ValueVehicle;
    private Date RegisterdDate;
    
    private DBConnection db = new DBConnection();
    private Connection newCon = null; 
    
     public InsertVehicle(String TransportMode,String VehicleType,String VehicleID, int ChassisNo, Date RegisterdDate, int NoOfSeats,int HiredPrice,int ValueVehicle, String Description,String Image){
