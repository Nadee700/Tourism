...
public class InsertDriver {
    private String DriverID,DriverName,NIC,Email,HomeCity; 
    private int ContactNo,Age;
    private  Date RegDate;
    private DBConnection db = new DBConnection();
    private Connection newCon = null;
    
    public InsertDriver(String DriverName,String DriverID,int ContactNo, String NIC,String Email,Date RegDate,int Age, String HomeCity){
