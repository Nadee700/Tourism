...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="container">
      ...
      <label for="vID"><b>Vehicle ID</b></label>
      <input type="text" placeholder="Enter Vehicale ID" name="vID" required>
      
      <label for="Date"><b>Created Date</b></label>
...
<img src="IMG/bus5.jpg" alt="Nature" style="width:70%"/>
