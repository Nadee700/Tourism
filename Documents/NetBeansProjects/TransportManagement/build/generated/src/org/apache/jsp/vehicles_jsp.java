...
public final class vehicles_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Vehicles</title>\n");
      out.write("        <style>       \n");
      ...
      out.write("        ");
            ...
            try{
                ...
                if(query!=null){
                    qry="SELECT * FROM add_vehicle where TransportMode like '%"+query+"%' or VehicleType like '%"+query+"%' or ChassisNo like '%"+query+"%' or RegisterdDate like '%"+query+"%'  or NoOfSeats like '%"+query+"%'  or HiredPrice like '%"+query+"%', or ValueVehicle like '%"+query+"%', Description like '%"+query+"%'";
      ...
      out.write("                    <th>Value Of Vehicle</th>\n");
      ...
      out.write("         </br>\n");
      out.write("        </br>\n");
      out.write("        <a href =\"addVehicle.jsp\" class=\"button\">Add Vehicle</a>\n");
      out.write("        \n");
      out.write("        <a href =\"vehicleList.jsp\" class=\"button\">Vehicle List</a>\n");
      out.write("        </br>\n");
      out.write("        </br>\n");
      out.write("    </center>\n");
      out.write("        <br/><br/><br/>\n");
      ...
      out.write("            <p>&copy;Copyright .Event Planing Services</p>\n");
      out.write("        </div>\n");
      out.write("        <script src=\"resources/jquery.min.js\"></script>\n");
      out.write("        <script src=\"resources/bootstrap.min.js\"></script>   <footer class=\"footer1\">\n");
